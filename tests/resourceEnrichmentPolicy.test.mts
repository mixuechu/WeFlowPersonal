...
test('idle enrichment is a first-class writer in scheduling, diagnostics and shutdown', () => {
  ...
  assert.match(service, /idle: !this\.memoryMaintenanceLease && !this\.activeSync && !this\.vectorIndexPromise && !this\.memorySearchRepairPromise &&\s*!this\.resourceEnrichmentPromise/)

...
function registerIpcHandlers() {
  ...
  ipcMain.handle('ai-assistant:updateGraphReview', (_, id: string, decision: 'confirmed' | 'rejected', options?: { mergeTargetEntityId?: string; correctedCanonicalName?: string }) => aiAssistantService.updateGraphReview(id, decision, options))

...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  aiAssistant: {
    ...
    updateGraphReview: (id: string, decision: 'confirmed' | 'rejected', options?: { mergeTargetEntityId?: string; correctedCanonicalName?: string; relationCorrection?: { subjectId?: string; predicate?: string; objectId?: string } }) => ipcRenderer.invoke('ai-assistant:updateGraphReview', id, decision, options),
